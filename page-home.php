...
get_header(); ?> 
    ...
    <div class="side-pad">
    	<div class="grid cta" style="background: url('<?php echo esc_url( get_theme_mod( 'cta_background' ), __( (get_stylesheet_directory_uri() . '/images/cta.jpg'), 'fitcoach' )); ?>') center center no-repeat;">
    		<div class="col-1-1">
