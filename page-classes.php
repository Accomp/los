			...
			<?php query_posts( array ( 'post_type' => 'classes', 'posts_per_page' => -1, 'order' => 'ASC' ) );
                ...
                <div class="col-1-3">
                	<div class="class-schedule custom_color custom_border_top">
				 		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('class-schedule'); ?></a>
                	...
                	<a href="<?php the_permalink(); ?>"><button class="schedule-class"><?php _e( 'More Details', 'fitcoach' ); ?></button></a>  
